...
export const planGeneratorThemeExtend = {
  colors: {
    ...
    mint: { DEFAULT: "var(--pg-mint)", tint: "var(--pg-mint-tint)", strong: "var(--pg-mint-strong)", ink: "var(--pg-mint-ink)" },
    sun: { DEFAULT: "var(--pg-sun)", tint: "var(--pg-sun-tint)", ink: "var(--pg-sun-ink)" },
    peach: { DEFAULT: "var(--pg-peach)", tint: "var(--pg-peach-tint)", strong: "var(--pg-peach-strong)", ink: "var(--pg-peach-ink)" },
    success: { DEFAULT: "var(--pg-success)", tint: "var(--pg-success-tint)" },
  },
  fontFamily: {
    display: ["var(--font-display)", "Pretendard", "Apple SD Gothic Neo", "Malgun Gothic", "sans-serif"],
    body: ["var(--font-body)", "Pretendard", "Apple SD Gothic Neo", "Malgun Gothic", "system-ui", "sans-serif"],
